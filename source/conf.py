...
project = u'FALCON'
copyright = u'2014-2026, icaoberg'
...
texinfo_documents = [
  ('index', 'FALCON', u'FALCON Documentation',
   u'icaoberg', 'FALCON', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = u'FALCON'
epub_author = u'icaoberg'
epub_publisher = u'icaoberg'
epub_copyright = u'2014-2026, icaoberg'
